...
STACK:HD2_W#FF0000:"HD2.5 write" \
STACK:HD_W#FFFF00:"HD3.5 write" \
COMMENT:" \j" \
COMMENT:" " \
AREA:SSD_R_NEGATIVE#0000FF:"SSD read" \
STACK:HD2_R_NEGATIVE#9400D3:"HD2.5 read" \
STACK:HD_R_NEGATIVE#00FF00:"HD3.5 read" \
COMMENT:" \j" \
COMMENT:" " \
COMMENT:" write maximum MB/s" \
GPRINT:SSD_W_MAX:"SSD \: %3.2lf" \
GPRINT:HD2_W_MAX:"HD2.5 \: %3.2lf" \
GPRINT:HD_W_MAX:"HD3.5 \: %3.2lf" \
COMMENT:" \j" \
COMMENT:" " \
COMMENT:" read  maximum MB/s" \
GPRINT:SSD_R_MAX:"SSD \: %3.2lf" \
GPRINT:HD2_R_MAX:"HD2.5 \: %3.2lf" \
GPRINT:HD_R_MAX:"HD3.5 \: %3.2lf" \
COMMENT:" \j" \
COMMENT:" " \
COMMENT:" write total MB/s" \
GPRINT:SSD_W_TOTAL:"SSD \: %3.2lf" \
GPRINT:HD2_W_TOTAL:"HD2.5 \: %3.2lf" \
GPRINT:HD_W_TOTAL:"HD3.5 \: %3.2lf" \
COMMENT:" \j" \
COMMENT:" " \
COMMENT:" read  total MB" \
GPRINT:SSD_R_TOTAL:"SSD \: %3.2lf" \
GPRINT:HD2_R_TOTAL:"HD2.5 \: %3.2lf" \
GPRINT:HD_R_TOTAL:"HD3.5 \: %3.2lf" \
COMMENT:" \j"
...
CDEF:FAN1_PERCENT=FAN1,100,*,1500,/,20,- \
