...
COMMENT:" " \
AREA:HD_1_W#FF0000:"HD1 write"  \
STACK:HD_2_W#FFD700:"HD2 write" \
STACK:HD_3_W#800000:"HD3 write" \
COMMENT:" \j" \
COMMENT:" " \
AREA:HD_1_R_NEGATIVE#4B0082:"HD1 read"  \
STACK:HD_2_R_NEGATIVE#00008B:"HD2 read"  \
STACK:HD_3_R_NEGATIVE#006400:"HD3 read" \
COMMENT:" \j" \
COMMENT:" " \
