...
CDEF:FAN2_PERCENT=FAN2,100,1400,1,*,/,* \
...
COMMENT:" " \
AREA:TEMP_CPU_PERCENT#FF00FF:"cpu temp" \
LINE1:FAN1_PERCENT#000000:"fan1" \
COMMENT:" \j" \
COMMENT:" " \
AREA:VOLT_IN0_PERCENT#0000CD:"volt0" \
STACK:VOLT_IN1_PERCENT#0000ff:"volt1" \
STACK:VOLT_IN2_PERCENT#1E90FF:"volt2" \
STACK:VOLT_IN3_PERCENT#87CEFA:"volt3" \
STACK:VOLT_IN4_PERCENT#006400:"volt4" \
STACK:VOLT_IN5_PERCENT#228b22:"volt5" \
STACK:VOLT_IN6_PERCENT#00FF00:"volt6" \
STACK:VOLT_3VSB_PERCENT#98FB98:"volt 3vsb" \
COMMENT:" \j" \
COMMENT:" " \
LINE1:LOAD_AVERAGE_PERCENT#FF0000:"load average" \
COMMENT:" \j" \
COMMENT:" " \
